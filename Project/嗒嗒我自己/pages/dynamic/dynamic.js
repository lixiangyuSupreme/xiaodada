Page({
  ...
  bindRegionChange: function (e) {
    ...
    wx.setStorageSync('position1', e.detail.value[0])
    wx.setStorageSync('position2', e.detail.value[1])
    wx.setStorageSync('position3', e.detail.value[2])
  },
  /**
   * 生命周期函数--监听页面加载
   */
  ...
  chooseimage:function(){
    ...
    wx.chooseImage({
      ...
      success: function (res) {
        ...
        wx.setStorageSync('src', img_url[0])
      }
    }
    ...
    send:function(res){
      ...
      // wx.uploadFile({
      //   url: 'https://www.youlewazi.top:1234/releasenews/', //仅为示例，非真实的接口地址
      ...
      // })
      // wx.request({
    //     url:'https://www.youlewazi.top:1234/releasenews/' + encodeURI(wx.getStorageSync('position1'))
    //     +'/'+ encodeURI(wx.getStorageSync('title')) 
    //     +'/'+ wx.getStorageSync('src') 
    //     +'/'+ encodeURI(wx.getStorageSync('position2'))
    //     +'/'+ encodeURI(wx.getStorageSync('position3'))
    //     +'/'+ encodeURI(wx.getStorageSync('style')),
    //     mathod:"post",
    //   data:{},
    //   header:{
